...
class RTree extends RBush {
   ...
   * @private
   * @returns {Number} Positive if 'a' x is greater than 'b' otherwise negative.
   */
  compareMinX(a, b) {
   ...
   * @param {Object} b Item #2.
   * @private
   * @returns {Number} Positive if 'a' y is greater than 'b' otherwise negative.
   */
  compareMinY(a, b) {
 ...
 * @returns {Promise} Promise with id and bbox added {id, bbox}.
 */
 ...
 * @returns {Promise} Promise array of id and bounding boxes loaded {id, bbox}.
 */
 ...
 * @returns {Promise} Promise of doc removed {id, bbox}.
 */
 ...
 * @returns {Promise} Promise with array objects with id and bbox properties.
 */
