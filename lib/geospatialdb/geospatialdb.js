...
const Util = {
   ...
   * @private
   * @returns {Promise} Promise with db put/post response.
   */
   ...
   * @private
   * @returns {Promise} Promise with db remove response.
   */
  remove: (db, id) => {
 ...
 * @private
 * @returns {Promise} Promise with array of document IDs.
 */
